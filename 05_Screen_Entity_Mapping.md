...
| **UC-004.1** | Tạo Mới Hồ Sơ Bệnh Nhân (Create) | `SCR-DOC-04`: Tạo mới hồ sơ bệnh nhân (<30s) | `PatientProfile` | `patients` | **C**: Tạo hồ sơ mới trong <30s; sinh mã `patient_id`; lưu tên viết tắt bảo mật NĐ 13/2023 (`status = 'ACTIVE'`). |
